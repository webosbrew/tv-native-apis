...
VT_STATUS_T VT_SetTextureSourceRegion(VT_CONTEXT_ID contextId, VT_SOURCE_REGION_T sourceRegion) { return -1; }
VT_STATUS_T VT_SetTextureSourceLocation(VT_CONTEXT_ID contextId, VT_SOURCE_LOCATION_T sourceLocation) { return -1; }
